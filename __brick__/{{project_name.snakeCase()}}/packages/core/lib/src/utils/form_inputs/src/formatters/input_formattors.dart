...
class InputFormatters {
  ...
  static final MaskTextInputFormatter numbersSplitBy4Formatter =
  ...
  static final MaskTextInputFormatter cellPhoneFormatter =
      MaskTextInputFormatter(
    MaskAutoCompletionType.lazy,
    mask: '## ######',
    filter: {'#': RegExp('[0-9]')},
  ...
  static final MaskTextInputFormatter astuPhoneFormatter =
      MaskTextInputFormatter(
    MaskAutoCompletionType.lazy,
    mask: '######',
    filter: {'#': RegExp('[0-9]')},
  ...
  static final MaskTextInputFormatter dateStringFormatter =
      MaskTextInputFormatter(
    MaskAutoCompletionType.lazy,
    mask: '##.##.####',
    filter: {'#': RegExp('[0-9]')},
  ...
  static final MaskTextInputFormatter welayatPhoneFormatter =
      MaskTextInputFormatter(
    MaskAutoCompletionType.lazy,
    mask: '### #####',
    filter: {'#': RegExp('[0-9]')},
  );
  static final MaskTextInputFormatter homePhoneFormatter =
      MaskTextInputFormatter(
    MaskAutoCompletionType.lazy,
    mask: '########',
    filter: {'#': RegExp('[0-9]')},
  ...
  static final MaskTextInputFormatter expirationDateFormatter =
      MaskTextInputFormatter(
    MaskAutoCompletionType.lazy,
    mask: '##/##',
    filter: {'#': RegExp('[0-9]')},
  ...
  static final MaskTextInputFormatter otpFormatter = MaskTextInputFormatter(
    MaskAutoCompletionType.lazy,
    mask: '#####',
    filter: {'#': RegExp('[0-9]')},
  );

  static final MaskTextInputFormatter numbersCVCFormatter =
      MaskTextInputFormatter(
    MaskAutoCompletionType.lazy,
    mask: '###',
    filter: {'#': RegExp('[0-9]')},
  ...
  static const NumberToAsteriskInputFormatter numbersToAsterisk =
      NumberToAsteriskInputFormatter();

  static final maskCarFineVideo = MaskTextInputFormatter(
    MaskAutoCompletionType.lazy,
    mask: '##/AAAAAAAAAA',
    filter: {
      '#': RegExp('[0-9]'),
  ...
  static final birthcCertificateFormatter = MaskTextInputFormatter(
    MaskAutoCompletionType.lazy,
    mask: 'A № #######',
    filter: {
      '#': RegExp('[0-9]'),
  ...
  static final maskCarFineInspector = MaskTextInputFormatter(
    MaskAutoCompletionType.lazy,
    mask: '#######',
    filter: {'#': RegExp('[0-9]')},
  );

  static final kabelTv = MaskTextInputFormatter(
    MaskAutoCompletionType.lazy,
    mask: '#####',
    filter: {'#': RegExp('[0-9]')},
  );

  static final alemTv = MaskTextInputFormatter(
    MaskAutoCompletionType.lazy,
    mask: '##########',
    filter: {'#': RegExp('[0-9]')},
  );

  static final hakimlik = MaskTextInputFormatter(
    MaskAutoCompletionType.lazy,
    mask: '###########',
    filter: {'#': RegExp('[0-9]')},
  );
...
class NumberToAsteriskInputFormatter extends TextInputFormatter {
  const NumberToAsteriskInputFormatter();
  ...
  TextEditingValue formatEditUpdate(
    ...
    for (int i = 0; i < newValue.text.length; i++) {
      if (newValue.text[i].isNotEmpty &&
          int.tryParse(newValue.text[i]) != null) {
        newText.write('*');
      } else {
...
class _TextMatcher {
  ...
  int get length =>
      _symbolArray.fold(0, (final prev, final match) => prev + match.length);
